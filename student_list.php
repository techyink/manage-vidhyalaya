...
if (!empty($user_id)) {
    ...
    if (isset($_GET['id']) && !empty($_GET['id'])) {
        ...
        if ($valueInsert > 0) {
            ...
            $error = "Student has not been deleted.";
        }
    }
    ?>
    <html>
        ...
        <body>
            ...
            <header id="head" class="secondary">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 style ="color: #800000;">Student List</h1>
                        </div>
                    </div>
                </div>
            </header>            
                        ...
                        <form class="form-light mt-20" role="form" method="post" action="user_list.php">
                            <table class="table_list">
                                ...
                                if (isset($_GET['status']) && $_GET['status'] == "success") {
                                    echo '<tr><td colspan="4">Student has been successfully deleted.</td></tr>';
                                }
                                if (!empty($error)) {
                                ...
                                <?php
                                $i = 0;
                                $sql = "SELECT * FROM users where user_type = 'student' ORDER BY name ASC";
                                $result = mysql_query($sql);
