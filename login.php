...
if (isset($_POST['btnsubmit'])) {
    ...
    if (empty($error)) {
      ...
      echo  $query = "Select id,name,email,user_type,imgpath from users where email = '$email' AND password = '$password'";
    ...
    <body>
        ...
        <header id="head" class="secondary">
            <div class="container">
                <div class="row">
                    <div class="col-sm-8">
                        <h1 style ="color: #800000;">Login</h1>
                    </div>
                </div>
            </div>
        </header>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <figure class="frame thumbnail alignnone clearfix">
                        <p><img class="size-full" alt="hld" src="images/delhi.png" width="" height="250"></p>
                    </figure>                   						
                </div>
            </div>
        </div>       
