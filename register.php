...
if (isset($_POST['btnsubmit'])) {
    ...
    if (empty($error)) {
         $sql_query = "INSERT INTO users(name,email,phone_no,password,adding_date,gender)"
        . "VALUES('" . $name . "','" . $email . "','" . $phone_no . "','" . $password . "','" . date('Y-m-d h:i:s') . "','" . $gender . "')";
    ...
    <body>
        ...
        <header id="head" class="secondary">
            <div class="container">
                <div class="row">
                    <div class="col-sm-8">
                        <h1 style ="color: #800000;">Register</h1>
                    </div>
                </div>
            </div>
        </header>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <figure class="frame thumbnail alignnone clearfix">
                        <p><img class="size-full " alt="haldwani" src="images/haldwani.png" width="" height="250"></p>
                    </figure>                   						
                </div>
            </div>
        </div>       
